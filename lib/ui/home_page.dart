...
import 'package:giffsearch/ui/gif_page.dart';
...
int _offset = 0;
 ...
 Future<Map> _getGifs() async {
    ...
    if(_search == null || _search.isEmpty){
      ...
      response = await http.get("https://api.giphy.com/v1/gifs/search?api_key=s21A2y5Zo7Tm03ejzWEeJmDwuDe1QvWh&q=$_search&limit=19&offset=$_offset&rating=g&lang=en");
    }
